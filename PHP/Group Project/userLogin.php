		...
		<div class="page">
			...
			<div class="body">
				<div id="featured">
					...
					<input type="button" value="Sign Up Now!" onClick="parent.location='UserRegister.php'"/> or
					<br/>
					
					<input type="button"value="Log in" onclick="parent.location='userLoginPage.php'"/>
				</div>
